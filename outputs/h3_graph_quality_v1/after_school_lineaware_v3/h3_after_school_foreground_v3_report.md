...
- manifest: `data/experiments/htr_graph_v1/graph_ready/tri10k_mixed_school_lineaware_v3/test.jsonl`
...
`cc_count`: Spearman r=0.1355, abs=0.1355, n=5563
...
| 7 | `all_features_no_text_len` | `global` | 5563 | 0.6431 | 0.3308 | 1.6172 | 0.3432 |
| 8 | `structural_core` | `global` | 5563 | 0.6423 | 0.3295 | 1.6108 | 0.3387 |
| 9 | `all_non_geometry` | `global` | 5563 | 0.6423 | 0.3295 | 1.6108 | 0.3387 |
| 10 | `all_features_no_text_len` | `dataset:school_notebooks_clean` | 2000 | 0.6258 | 0.3678 | 1.6494 | 0.3725 |