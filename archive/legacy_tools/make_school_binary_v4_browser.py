...
from src.preprocessing.school_foreground_v4 import (
    adaptive_raw_hysteresis,
    flattened_hysteresis,
    global_dark_120,
...
VARIANTS = [
    ...
    "global_dark_120",
    "adaptive_raw_hysteresis",
    "gray_flat_hysteresis",
    "rgb_whitebalance_flat_hysteresis",
]
...
def make_variant(
    ...
    if name == "global_dark_120":
        return global_dark_120(
            gray
        )

    if name == "adaptive_raw_hysteresis":
        return adaptive_raw_hysteresis(
            gray,
            support,
        )

    if name == "gray_flat_hysteresis":
        return flattened_hysteresis(
            rgb,
            support,
            white_balance=False,
        )
