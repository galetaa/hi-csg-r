...
from src.preprocessing.school_foreground_v4 import (
    choose_school_foreground_v5,
    flat_raw_seeded_rescue,
    global_dark_120,
    load_rgb_and_support,
    raw_seeded_hysteresis,
    school_dark_auto_v2,
)
...
def make_variant(
    ...
    if name == "raw_seeded_145_120":
        return raw_seeded_hysteresis(
            gray,
            support,
    ...
    if name == "flat_raw_seeded_rescue":
        return flat_raw_seeded_rescue(
            rgb,
            gray,
            support,
            white_balance=False,
    ...
    if name == "school_foreground_v5_auto":
        fg, _method = choose_school_foreground_v5(
            rgb,
            gray,
            support,
        )
