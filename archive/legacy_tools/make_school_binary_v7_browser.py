...
def make_variant(
    ...
    if name == "paper_ratio_capped_hysteresis":
        foreground, _threshold = (
            paper_ratio_capped_hysteresis(
                gray,
                support,
                strong_threshold=120,
                maximum_weak_threshold=135,
                maximum_total_fraction=0.24,
                maximum_expansion=1.50,
                minimum_extra_fraction=0.015,
                maximum_border_fraction=0.12,
                proximity_px=2,
            )
        )
